...
try:
    ...
    st.error(f"La hoja de cálculo con la clave '{SPREADSHEET_KEY}' no fue encontrada.")
...
def main():
    ...
    if df.empty:
        st.warning("No se encontró ningún video en la base de datos.")
        return
    ...
    with st.sidebar:
        ...
        df_1_1 = sorted(df_1)
        slb_1 = st.selectbox('Categoría', df_1_1)
